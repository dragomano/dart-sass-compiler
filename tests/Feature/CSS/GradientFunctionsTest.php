...
describe('gradient functions', function () {
    ...
    it('tests radial-gradient support', function () {
        $scss = '.test { background: radial-gradient(circle, red, blue); }';
    ...
    it('tests conic-gradient support', function () {
        $scss = '.test { background: conic-gradient(red, blue); }';
    ...
    it('tests repeating-linear-gradient support', function () {
        $scss = '.test { background: repeating-linear-gradient(45deg, red, blue 10px); }';
    ...
    it('tests repeating-radial-gradient support', function () {
        $scss = '.test { background: repeating-radial-gradient(circle, red, blue 10px); }';
    ...
    it('tests repeating-conic-gradient support', function () {
        $scss = '.test { background: repeating-conic-gradient(red, blue 45deg); }';

        $expected = /** @lang text */ <<<'CSS'
        .test {
          background: repeating-conic-gradient(red, blue 45deg);
        }
        CSS;
