...
describe('KeyframesRuleParser', function () {
    ...
    it('throws syntax exception when keyframes missing opening brace', function () {
        $parser = ($this->createParser)('@keyframes myAnimation color: red;');

        expect(fn() => $parser->parse())->toThrow(
            SyntaxException::class,
            'Expected "{" after @keyframes'
        );
    });
