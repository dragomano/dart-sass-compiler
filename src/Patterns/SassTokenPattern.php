...
enum SassTokenPattern: string
{
    case NEWLINE                   = '(?P<newline>\n)';
    ...
    case UNARY_OPERATOR            = '(?P<unary_operator>not)';
    case CSS_CUSTOM_PROPERTY       = '(?P<css_custom_property>--[a-zA-Z0-9_-]+)';
    case PSEUDO_CLASS              = '(?P<pseudo_class>:[a-zA-Z_-][a-zA-Z0-9_-]*(?:\([^)]*\))?)';
    ...
    case COLON                     = '(?P<colon>:)';
    case PLACEHOLDER_SELECTOR      = '(?P<placeholder_selector>%[a-zA-Z_][a-zA-Z0-9_-]*)';
}
